...
class LaikagoHouse:
    '''
    AGENT FOR HOUSE PPO ENVIRONMENT
    '''
    def __init__(self, client, dt=1./500):
        ...
        self.lower_act = np.array([-0.1, -0.4, -1.4, -0.1, -0.4, -1.4, -0.1, -0.4, -1.4, -0.1, -0.4, -1.4,
        ])
        self.upper_act = np.array([0.1, 0.6, -0.4, 0.1, 0.6, -0.4, 0.1, 0.6, -0.4, 0.1, 0.6, -0.4,
        ])            
        self.last_pos = None
    ...
    def get_observation(self, timestep, encoder):
        ...
        observation = np.array(self.ori+list(self.vel[1])+self.motor_positions)
    ...
    def calculate_reward(self, done, timestep):
        ...
        R = (1-w)*r1 + w*r2 + r3 - 0.1*r4 - 5*r5
        #print(f"R: {R}, r1: {r1}, r2: {r2}, r3: {r3}, r4: {r4}, r5: {r5}, falling: {falling}")
