...
from resources.laikago_cpg_4legs_v2 import LaikagoCPG as Laikago

class plainCPGEnv(gym.Env):
    '''
    PLAIN ENVIRONMENT WITH DIFFERENT OFFSET FOR FRONT/BACK LEGS. GOES WITH LAIKAGO_CPG_4LEGS_V2
    '''
    def __init__(self, mode=0, freq_range=[3.0, 8.0], gamma=5.0):
        ...
        self.action_space = gym.spaces.box.Box(
            low=np.array([0, 0.0, 0.0, 0.0, 0.5, 0.0, 0.3, 0.0, 0.3]),
