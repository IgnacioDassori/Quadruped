...
from agents.laikago_houseV2 import LaikagoHouse as Laikago

class houseEnv(gym.Env):
    '''
    HOUSE ENVIRONMENT WITHOUT OBSTACLES, ADDED CORONAL MOTORS
    '''
    def __init__(self, mode, freq_range, gamma, vae_path, spawn_objects=False, env_id=None, log_dir=None):
        ...
        # roll, pitch, yaw (x3), angular velocities (x3), motor positions (x12), phase & CPG parameters (x5)
        # latent vector (X32)
