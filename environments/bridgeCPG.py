...
from resources.ramp import Bridge

class oneSlopeEnv(gym.Env):
    '''
    CPG 4 LEGS ONE SLOPE ENV
    '''
    def __init__(self, mode, freq_range, gamma):
        super(oneSlopeEnv, self).__init__()
    ...
    def reset(self):
        ...
        # load bridge urdf
        bridge = Bridge(client=self.client, pitch=-math.pi/18)
